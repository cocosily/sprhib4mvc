...
<title>jQuery ligerUI Demos导航主页</title>
    ...
    <script src="${pageContext.request.contextPath }/ligerUI/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script> 
    <script src="${pageContext.request.contextPath }/ligerUI/lib/ligerUI/js/plugins/ligerTab.js"></script>
    <script src="${pageContext.request.contextPath }/ligerUI/lib/jquery.cookie.js"></script>
    <script src="${pageContext.request.contextPath }/ligerUI/lib/json2.js"></script>
    <script src="${pageContext.request.contextPath }/ligerUI/indexdata.js" type="text/javascript"></script>
...
<style type="text/css"> 
    ...
    #pageloading{position:absolute; left:0px; top:0px; background:white url('ligerUI/lib/images/loading.gif') no-repeat center; width:100%; height:100%;z-index:99999;}
    ...
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:26px;background:url('ligerUI/lib/images/topicon.gif') no-repeat 10px 5px;}
