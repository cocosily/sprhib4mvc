...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="index.html"><img src="${ctx }/adminex/images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="index.html"><img src="${ctx }/adminex/images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="${ctx }/adminex/images/photos/user-avatar.png" class="media-object">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
            	<c:forEach items="${resList }" var="res">
	                <li class="menu-list"><a href="index.html"><i class="fa fa-home"></i> <span>${res.resname }</span></a>
	                    <ul class="sub-menu-list">
	                    	<c:forEach items="${res.childResources }" var="chiildres">
	                        <li><a href="javascript:void(0);" onclick="loadMainContent('${chiildres.resurl }');" >${chiildres.resname }</a></li>
    ...
    <div class="main-content" >
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="adminex/images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="adminex/images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="adminex/images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="adminex/images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="adminex/images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="${ctx }/adminex/images/photos/user-avatar.png" alt="" />
                            John Doe
        ...
        <!--body wrapper start-->
        <div class="wrapper" id="mainPageContent">
        </div>
        <!--body wrapper end-->
...
<script src="${ctx }/adminex/js/flot-chart/jquery.flot.pie.resize.js"></script>
<script src="${ctx }/adminex/js/flot-chart/jquery.flot.selection.js"></script>
<script src="${ctx }/adminex/js/flot-chart/jquery.flot.stack.js"></script>
<script src="${ctx }/adminex/js/flot-chart/jquery.flot.time.js"></script>
<script src="${ctx }/adminex/js/main-chart.js"></script>
...
function loadMainContent(url){
	var _url = '${ctx }'+'/ad/newlist';
	$("#mainPageContent").load(
		_url,
		{}
	);
}
