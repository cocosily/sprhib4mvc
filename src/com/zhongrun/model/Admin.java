...
public class Admin implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2030941302336024398L;
	
	@Id
	@SequenceGenerator(name = "ADMINPK", allocationSize=1, initialValue=1, sequenceName = "SEQ_SYSTEM_ADMIN")
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator = "ADMINPK")
