package com.zhongrun.common.service.impl;

import com.zhongrun.common.Constant;
import com.zhongrun.common.dao.IBaseDao;
import com.zhongrun.common.pagination.Page;
import com.zhongrun.common.pagination.PageUtil;
import com.zhongrun.common.service.IBaseService;
...
public abstract class BaseService<M extends java.io.Serializable, PK extends java.io.Serializable> implements IBaseService<M, PK> {
    ...
    public Page<M> listAll(int pn) {
        ...
        return this.listAll(pn, Constant.DEFAULT_PAGE_SIZE);
    }
    
    public Page<M> listAllWithOptimize(int pn) {
        return this.listAllWithOptimize(pn, Constant.DEFAULT_PAGE_SIZE);
    }
    ...
    public Page<M> pre(PK pk, int pn) {
        return pre(pk, pn, Constant.DEFAULT_PAGE_SIZE);
    }
    @Override
    public Page<M> next(PK pk, int pn) {
        return next(pk, pn, Constant.DEFAULT_PAGE_SIZE);
    }
